...
import { User, Mail, Phone, MapPin, Briefcase, Clock, DollarSign, Save } from 'lucide-react';
        ...
        {submitted ? (
          ...
          <form onSubmit={handleSubmit}>
            <div className="flex flex-wrap -mx-2">
              {/* Profile Image */}
              <div className="w-full md:w-1/4 px-2 flex justify-center items-start mb-6">
              ...
              <div className="w-full md:w-3/4 px-2">
                <div className="flex flex-wrap -mx-2">
                  ...
                  <div className="w-full md:w-1/2 px-2 mb-4">
                    <div className="bg-gray-50 p-4 rounded-lg h-full">
                      <h2 className="text-lg font-semibold mb-3 text-gray-800">Job Preferences</h2>
                      <div className="space-y-3">
                        <div className="relative">
                          <label className="block text-sm font-medium text-gray-700 mb-1">Hourly Rate</label>
                          <div className="flex items-center">
                            <DollarSign className="text-gray-400 absolute ml-3" size={18} />
                            <input
                              type="text"
                              name="hourlyRate"
                        ...
                        <div className="relative">
                          ...
                          <div className="flex items-center">
                            <Clock className="text-gray-400 absolute ml-3" size={18} />
                            <input
                              type="text"
                              name="schedule"
                              ...
                              onChange={handleInputChange}
                              className="w-full pl-10 pr-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                              placeholder="Flexible afternoons and weekends"
                            />
                          </div>
                        </div>
                        
                        <div>
                          <label className="block text-sm font-medium text-gray-700 mb-1">Industries (up to 3)</label>
                ...
                <div className="w-full px-2 mb-4">
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <h2 className="text-lg font-semibold mb-3 text-gray-800">About Me</h2>
                    <div>
            ...
            <div className="flex justify-center mt-4">
              ...
              >
                {submitting ? (
                  ...
                  <>
                    <Save className="mr-2" /> Create Profile
                  </>
                )}
              </button>
            </div>
